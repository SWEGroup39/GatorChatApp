  ...
  onGetUser():void{
    ...
    this.userService.getUser(this.user.password, this.user.username).subscribe(
      (response) => {
       ...
       sessionStorage.setItem('currentUserU', username)
       sessionStorage.setItem('currentUserP',password)
       sessionStorage.setItem('currentUserE',email)
       sessionStorage.setItem('currentUserI', user_id)
